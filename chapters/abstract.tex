...
to sample from the output distribution of random quantum circuits. 
...
and a depth of up to 20 cycles accurately. When trained with AdaMax, the best performing 
RBMs were able to approximate the true output distributions with a TVD of 0.01 on all circuits.
The non-diagonal single-qubit gates could be applied within less than 100 training iterations. 
