...
This process is repeated for a predefined number of iterations. Using this approach and AdaMax as the optimization method, J\'{o}nsson et al. reported a per gate error of $10^{-3}$ 
for the tested kind of quantum circuits \cite{jnsson2018neuralnetwork}.
